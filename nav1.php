...
<nav class="topnav" id="mytopnav">
		...
		// Display the following two links only if the session variable ID exists
			if(isset($_SESSION['uid'])){
				echo '<a href="php/index.php" style ="font-family: Lemonada, sans-serif; color: #D8BFD8;">Howlie<br></a>';
                echo '<a href="php/profilereal.php">PROFILE</a>';
                echo '<a href="php/searchtest.php">MATCHES</a>';
                echo '<a href="index1.php">FUNZO BOARD</a>';
                echo '<a href="php/profile.php">ACCOUNT INFO</a>';
				echo '<a href="php/logout.php">LOGOUT</a>';
                echo  '<a href="php/contact.php">CONTACT US</a>';
                 echo  '<a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>';
			}
        else {
        echo '<a href="php/index.php" style ="font-family: Lemonada, sans-serif; color: #D8BFD8;">Howlie<br></a>';
        echo  '<a href="php/index.php">HOME</a>';	
